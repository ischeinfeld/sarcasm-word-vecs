...
MODEL_FNAME_FORMAT = "cnn_model.pkl"
OUT_FNAME = "output.pred"
LOG_FNAME = "cnn.log"
N_EPOCHS = 1
...
def train_conv_net(train_data,
    ...
    if train_data.shape[0] % batch_size > 0:
        ...
        ###!!! assume data is already shuffuled
    ...
    #pickle.dump(classifier, open(model_file, "wb"), protocol=pickle.HIGHEST_PROTOCOL)
...
def train():
    ...
    '''the above outputs a matrix - words, their vectors'''
